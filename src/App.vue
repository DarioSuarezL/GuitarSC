        ...
        <div class="container-xl">
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    ...
                    <p class="mt-5 fs-5 text-white">Una guitarra que captura la esencia del virtuosismo de Steve Vai, perfecta para solos rápidos y expresivos. Su diseño ergonómico facilita la interpretación técnica y el acceso a tonos brillantes y nítidos.</p>
